...
class Pipe:
    ...
    def __init__(self, x):
        ...
        self.top = 0
        self.bottom = 0
        self.PIPE_TOP = pygame.transform.flip(BIRD_IMGS[3], False, True)
        self.PIPE_BOTTOM = BIRD_IMGS[3]
        self.passed = False
        self.set_height()
...
if __name__ == "__main__":
    ...
    confiig_path = os.path.join(local_dir, "config.txt")
    run(confiig_path)
